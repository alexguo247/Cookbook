...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_request(self):
        """Test uploading an invalid recipe"""
        url = image_upload_url(self.recipe.id)
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Random recipe 1')
        recipe2 = sample_recipe(user=self.user, title='Random recipe 2')
        tag1 = sample_tag(user=self.user, name='Random tag 1')
        tag2 = sample_tag(user=self.user, name='Random tag 2')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title='Random recipe 3')
        res = self.client.get(
            RECIPES_URL,
